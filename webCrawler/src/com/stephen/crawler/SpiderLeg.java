...
public class SpiderLeg
{
    ...
    private Map<String, List<String>> linkGraph = new HashMap<>();

    public void buildGraph() {
        for (String link : links) {
            List<String> connectedLinks = getConnectedLinks(link);
            linkGraph.put(link, connectedLinks);
        }
    }
    private List<String> getConnectedLinks(String link) {
        List <String> connectedLinks = new LinkedList<>();
